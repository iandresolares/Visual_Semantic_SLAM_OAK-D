...
protected:
  ...
  ros::Subscriber oakd_sub_;
  ros::Subscriber oak_odom_sub_;
...
protected:
  ...
  void detectedObjectOakdCallback(const semantic_SLAM::BoundingBoxes &msg);
  void oakVIOCallback(const nav_msgs::OdometryConstPtr &odom_msg);
  // publishers
protected:
